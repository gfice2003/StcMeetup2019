...
public class Dispatcher implements IReceiver {
    ...
    public void receive(Message message) {
        ...
        if (messageType.equals("EXCEPTION_MESSAGE")) {
    ...
    private Message generateExceptionMessage(Message request, Throwable exception) {
        //-- Exception message generation logic here
        return null;
    }
}
